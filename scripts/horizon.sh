...
openstack_dashboard_conf=/etc/apache2/conf-enabled/openstack-dashboard.conf
settings=/etc/openstack-dashboard/local_settings.py
...
#    ('Cloudbase', 'Cloudbase', 'themes/ubuntu'),
#]
...
rm -f $openstack_dashboard_conf 2>/dev/null
 ...
 cat >> $openstack_dashboard_conf << EOF
